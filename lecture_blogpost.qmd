...
We can also try running the final URL which we create with the above functions (until line 5) in our browser, as we did before, to see what the structure of our data looks like:
