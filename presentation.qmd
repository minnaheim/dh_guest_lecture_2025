...
<!-- aurel: Suggestion: learn to identify and understand the use of APIs in real-world contexts -->
...
<!-- aurel: I removed the command library(utils), as it is loaded by default and might confuse students. The rest is perfect!! -->
::: {.panel-tabset}
...
<!-- aurel: the link is down. this works: https://api-ninjas.com/api/stockprice -->
...
## 3. Using an API Wrapper {.smaller}
...
<!-- aurel: This is great! It is well illustrated, captivating for students, great examples, the story ark is also well structured. I am looking forward to it.  -->

<!-- In terms of timing, it should be perfect for the first hour.  -->

<!-- One thing I would pay attention to: since this is new for students, I would emphasize what was your thought process when preparing the example. More concretely: how did you know about ninja API, how did you know where to look? and how did you find out about query1.finance.yahoo.com/v8/finance/? did you google it?  -->