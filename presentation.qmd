...
<!-- Speaker Notes: We want to reconstruct this, create our own Index -->
...
<!-- Speaker Notes: it looks like this because this is for non-technical people (who use excel), and because its nice to look at -->
...
Speaker Notes:
  ...
  - API = Waiter 
  - Server = Kitchen 
  - Menu = API Documentation (see endpoints & param)
  - Client = You
  - Order = API call
  - HTTP request 
      GET = get food (param = add onions), 
      POST = send back, 
      PUT = modify something about your food (once it is already out)
  - Food = Response (Json, e.g. )
...
## API Conceptually
<!-- Speaker Notes:
  translate from analogy to diagram 
   -->
![](/img/api_diagram_w_url.png){fig-align="center"}

## API Example 
<img src="/img/api_example_link.png"  style="display:block; margin:0 auto; width:90%;">
<!-- 
Speaker Notes: 
...
![](/img/api_wrapper_met.png){fig-align="center"}
