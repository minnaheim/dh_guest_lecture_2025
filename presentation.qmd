...
<!-- - Finance: the [Bloomberg API](https://www.bloomberg.com/professional/support/api-library/) -->
<!-- - Social Media: the [Youtube API](https://developers.google.com/youtube/v3), Twitter API, etc.  -->
<!-- - Geodata: Google Maps, OpenStreetMap, etc. -->
<!-- - Connect to your Spotify account to retrieve data, or to your Garmin or Strava account for training data -->
<!-- - OpenAI API -->
<!-- - Others: [Chuck Norris Jokes API](https://api.chucknorris.io/) -->
