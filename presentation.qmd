---
title: "APIs for Economic Data"
subtitle: "Guest Lecture 2025"
author: "Minna Heim"
...
## About the institute and our work
...
# remove old headers (before pivot these used to be the first two columns)
gdp_long <- gdp_long[-c(1:2),]
# check structure
# str(gdp_long)

# convert to gdp num and year to int
...
##
<img src="/img/api_url.png"  style="display:block; margin:0 auto; width:80%;">
<!-- 
Speaker Notes: 
...
```
- copy this template at: [https://minnaheim.github.io/dh_guest_lecture_2025/presentation.html](https://minnaheim.github.io/dh_guest_lecture_2025/presentation.html)
