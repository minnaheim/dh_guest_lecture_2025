...
<!-- by googling, and trying out which API services, such as Ninja API offer, and if it's free or not, you find out what works best for your needs -->
- we can use alternative (non-open source) APIs 
- such as [API Ninja](https://api-ninjas.com/api/stockprice) 
