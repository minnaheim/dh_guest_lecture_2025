...
Speaker Notes:
  ...
  API Protocol:
  - the APIs we are concerned with and encounter most frequently are called: web APIs and REST APIs (mostly) use the HTTP, a type of protocol
  ...
  - most importantly: HTTP has 4 main verbs: GET, POST, DELETE, PUT
 -->
