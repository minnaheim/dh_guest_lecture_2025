...
<!-- Great metapher :-) I wonder how many BA students nowadays know what photocopying is... -->
...
<!-- aurel: could you add a line on what the plumber package is? -->
...
<!-- aurel: maybe a suggestion for story here: instead of showing the partition_ts and the three functions at first, proceed like an onion. First the core, which is your “Everything Please” function without start and endpoint. Show how you save it in plumber and use it. Do not introduce partition_ts yet. 
Then show why we need start and end points, for which we require “Custom Order” partition_ts. 
So advanced studetns will get the whole story, while students unfamiliar with this content will get the main idea at first, and won't get lost. Also studetns are not familiar with reading complex functions with many control statements, so they might be distracted by code. -->
